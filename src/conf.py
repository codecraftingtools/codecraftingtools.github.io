...
htmlhelp_basename = 'CodeCraftsmendoc'
...
man_pages = [
    (master_doc, 'codecraftsmen', u'Code Craftsmen Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'CodeCraftsmen', u'Code Craftsmen Documentation',
     author, 'CodeCraftsmen', 'One line description of project.',
     'Miscellaneous'),
]
...
intersphinx_mapping = {
    ...
    'finch': ('https://finch-format.readthedocs.io/en/latest/', None),
