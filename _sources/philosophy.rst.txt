...
and changes in response to its environment.  New requirements cause it
...
growth of a code base to keep it healthy, manageable, and beautiful.
...
code often tends to live on longer than we anticipate.
